...
/**
 * Describes a sample to be analysed Here, very partial implementation. We can
 * only add a result, and recover the last result
 */
public class Sample {
    ...
    /**
     * Id number for the sample. The id must be unique. It is assigned during
     * sample creation
     */
    ...
    /**
     * Returns the last result of the sample, as the toString function of the
     * result Returns the null String if no result available
     */
    ...
    /**
     * States if the sample has been completely analysed : - the result is known
     * and validated - or, after three attempts, it is not readable
     */
    public boolean isCompleted() {
        ...
        if (status == ResultStatus.UNREADABLE && results.size() >= 3) {
            return true;
        }
        return false;
    }
